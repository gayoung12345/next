...
TextareaWrapper.displayName = 'TextareaWrapper'; // displayName 추가
...
Textarea.displayName = 'Textarea'; // displayName 추가
...
TextareaInput.displayName = 'TextareaInput'; // displayName 추가
