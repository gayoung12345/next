...
PrimitiveIcon.displayName = 'PrimitiveIcon'; // Add display name
...
InputWrapper.displayName = 'InputWrapper'; // Add display name
...
cssInterop(UIInput.Icon, {
    className: {
        target: 'className', // Correct target value
        nativeStyleToProp: {
            height: true,
            width: true,
            // fill: true,
...
InputIcon.displayName = 'InputIcon'; // Add display name
...
InputSlot.displayName = 'InputSlot'; // Add display name
