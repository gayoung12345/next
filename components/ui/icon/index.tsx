...
PrimitiveIcon.displayName = 'PrimitiveIcon'; // Add displayName
...
const nativeStyleConfig: NativeStyleToPropConfig = {
    height: 'height',
    width: 'width',
    fill: 'fill',
    color: 'color',
...
cssInterop(UIIcon, {
    className: {
        target: 'style',
        nativeStyleToProp: nativeStyleConfig,
    },
});
...
Icon.displayName = 'Icon'; // Add displayName
...
const createIconUI = ({ ...props }: ParameterTypes) => {
    ...
    ForwardedIcon.displayName = 'ForwardedIcon'; // Add displayName
